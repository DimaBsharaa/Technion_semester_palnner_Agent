...
def agent_info():
    ...
    return {
        "description": (
            "APEX plans a Technion student's next semester from free-text input in Hebrew or English. "
            "It reads the student's track, semester, passed and failed courses, blocked days, pace, "
            "requested courses, and grades. If key information is missing, it asks only for that detail; "
            "otherwise it builds a checked plan with course reasoning, timetable, exam dates, workload, "
            "risk notes, and a roadmap to graduation.\n\n"
            "During planning, APEX uses real course data and tools for catalog lookup, requirements, "
            "prerequisites, section-level schedules, exam spacing, CheeseFork reviews, historical grade "
            "averages, risk reporting, and a live check that selected courses are offered next semester. "
            "It supports three Technion tracks.\n\n"
            "APEX can parse an uploaded grade sheet PDF, prioritize failed retakes, advise on "
        ...
        "prompt_template": {
            "template": (
                ...
                "Grades: <optional - list low grades, or upload a transcript PDF in the GUI>\n"
